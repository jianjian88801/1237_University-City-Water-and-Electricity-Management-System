<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="领用设备" prop="lingyongshebei">
          <el-input v-model="ruleForm.lingyongshebei" 
              placeholder="领用设备" clearable  :readonly="ro.lingyongshebei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="领用设备" prop="lingyongshebei">
              <el-input v-model="ruleForm.lingyongshebei" 
                placeholder="领用设备" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="消耗设备" prop="xiaohaoshebei">
          <el-input v-model="ruleForm.xiaohaoshebei" 
              placeholder="消耗设备" clearable  :readonly="ro.xiaohaoshebei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="消耗设备" prop="xiaohaoshebei">
              <el-input v-model="ruleForm.xiaohaoshebei" 
                placeholder="消耗设备" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="总数量" prop="zongshuliang">
            <el-input v-model="zongshuliang"
                placeholder="总数量" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zongshuliang" label="总数量" prop="zongshuliang">
              <el-input v-model="ruleForm.zongshuliang" 
                placeholder="总数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
    zongshuliang: {
      get: function () {
        return 0+parseFloat(this.ruleForm.lingyongshebei==""?0:this.ruleForm.lingyongshebei)+parseFloat(this.ruleForm.xiaohaoshebei==""?0:this.ruleForm.xiaohaoshebei) || 0
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuefen = true;
          ...
          if(o=='lingyongshebei'){
            this.ruleForm.lingyongshebei = obj[o];
	    this.ro.lingyongshebei = true;
            continue;
          }
          if(o=='xiaohaoshebei'){
            this.ruleForm.xiaohaoshebei = obj[o];
	    this.ro.xiaohaoshebei = true;
            continue;
          }
          if(o=='zongshuliang'){
            this.ruleForm.zongshuliang = obj[o];
	    this.ro.zongshuliang = true;
            continue;
          }
          if(o=='dengjiriqi'){
    ...
    onSubmit() {
      ...
      // ${column.compare}
      // ${column.compare}
        this.ruleForm.zongshuliang = this.zongshuliang
      // ${column.compare}
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `banzubaobiao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.banzubaobiaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
