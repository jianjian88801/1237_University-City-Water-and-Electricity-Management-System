<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="维护单号" prop="weihudanhao">
            <el-input v-model="ruleForm.weihudanhao" 
                placeholder="维护单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.weihudanhao" label="维护单号" prop="weihudanhao">
              <el-input v-model="ruleForm.weihudanhao" 
                placeholder="维护单号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="维护日期" prop="weihuriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.weihuriqi" 
                type="date"
                placeholder="维护日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.weihuriqi" label="维护日期" prop="weihuriqi">
              <el-input v-model="ruleForm.weihuriqi" 
                placeholder="维护日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="维护内容" prop="weihuneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.weihuneirong" label="维护内容" prop="weihuneirong">
                    <span v-html="ruleForm.weihuneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.weihuriqi = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='weihudanhao'){
            this.ruleForm.weihudanhao = obj[o];
	    this.ro.weihudanhao = true;
            continue;
          }
	    ...
	    this.ro.weihuneirong = true;
          ...
          if(o=='weihuriqi'){
            this.ruleForm.weihuriqi = obj[o];
	    this.ro.weihuriqi = true;
            continue;
          }
          if(o=='beizhu'){
	...
	this.ruleForm.weihuneirong = this.ruleForm.weihuneirong.replace(reg,'../../../springbootrze22/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `weihubaoyang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.weihubaoyangCrossAddOrUpdateFlag = false;
                  this.parent.search();
