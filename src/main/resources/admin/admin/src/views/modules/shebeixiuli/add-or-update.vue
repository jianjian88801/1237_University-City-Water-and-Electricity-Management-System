<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="修理人员" prop="xiulirenyuan">
          <el-input v-model="ruleForm.xiulirenyuan" 
              placeholder="修理人员" clearable  :readonly="ro.xiulirenyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="修理人员" prop="xiulirenyuan">
              <el-input v-model="ruleForm.xiulirenyuan" 
                placeholder="修理人员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="修理日期" prop="xiuliriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.xiuliriqi" 
                type="date"
                placeholder="修理日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiuliriqi" label="修理日期" prop="xiuliriqi">
              <el-input v-model="ruleForm.xiuliriqi" 
                placeholder="修理日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.xiuliriqi = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shebeimingcheng = true;
          ...
          if(o=='xiulirenyuan'){
            this.ruleForm.xiulirenyuan = obj[o];
	    this.ro.xiulirenyuan = true;
            continue;
          }
          if(o=='wentimiaoshu'){
	    ...
	    this.ro.wentimiaoshu = true;
          ...
          if(o=='xiuliriqi'){
            this.ruleForm.xiuliriqi = obj[o];
	    this.ro.xiuliriqi = true;
            continue;
          }
          if(o=='beizhu'){
	...
	this.ruleForm.wentimiaoshu = this.ruleForm.wentimiaoshu.replace(reg,'../../../springbootrze22/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shebeixiuli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shebeixiuliCrossAddOrUpdateFlag = false;
                  this.parent.search();
