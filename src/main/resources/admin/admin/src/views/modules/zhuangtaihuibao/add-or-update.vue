<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="汇报编号" prop="huibaobianhao">
            <el-input v-model="ruleForm.huibaobianhao" 
                placeholder="汇报编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.huibaobianhao" label="汇报编号" prop="huibaobianhao">
              <el-input v-model="ruleForm.huibaobianhao" 
                placeholder="汇报编号" readonly></el-input>
          </el-form-item>
        </div>
...
export default {
  ...
  created() {
	this.ruleForm.huibaoshijian = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='huibaobianhao'){
            this.ruleForm.huibaobianhao = obj[o];
	    this.ro.huibaobianhao = true;
            continue;
          }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhuangtaihuibao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhuangtaihuibaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
