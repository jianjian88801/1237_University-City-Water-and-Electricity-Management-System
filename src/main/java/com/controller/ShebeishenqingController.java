...
public class ShebeishenqingController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ShebeishenqingEntity shebeishenqing,
		HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			shebeishenqing.setZhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShebeishenqingEntity shebeishenqing, 
		HttpServletRequest request){
        EntityWrapper<ShebeishenqingEntity> ew = new EntityWrapper<ShebeishenqingEntity>();
		PageUtils page = shebeishenqingService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shebeishenqing), params), params));
        return R.ok().put("data", page);
